...
function ReasoningTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-reasoning-trigger group/trigger text-foreground/55 hover:text-foreground/90 flex items-center gap-1.5 rounded-md py-1 text-[13.5px] outline-none transition-colors",
        className,
      )}
      {...props}
    >
      <ChevronRightIcon
        ...
        className={cn(
          "aui-reasoning-trigger-chevron size-3.5 shrink-0 opacity-60",
          "transition-transform duration-(--animation-duration) ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none",
          "group-data-open/trigger:rotate-90",
...
function ReasoningText({
  ...
  return (
    <div
      ...
      className={cn(
        "aui-reasoning-text relative z-0 max-h-64 overflow-y-auto ps-4 pt-2.5 pb-2 leading-relaxed text-pretty",
